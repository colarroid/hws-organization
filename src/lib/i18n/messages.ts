...
const en: Record<MessageKey, string> = {
  ...
  "stats.reached": "women sent to you",
...
const gd: Catalogue = {
  ...
  "stats.reached": "boireannaich air an cur thugaibh",
...
const sco: Catalogue = {
  ...
  "stats.reached": "weemen sent tae ye",
...
const pl: Catalogue = {
  ...
  "stats.reached": "kobiet skierowanych do was",
...
const uk: Catalogue = {
  ...
  "stats.reached": "жінок направлено до вас",
...
const ar: Catalogue = {
  ...
  "stats.reached": "امرأة أُحلن إليكم",
...
const ur: Catalogue = {
  ...
  "stats.reached": "خواتین آپ کے پاس بھیجی گئیں",
...
const pa: Catalogue = {
  ...
  "stats.reached": "ਔਰਤਾਂ ਤੁਹਾਡੇ ਕੋਲ ਭੇਜੀਆਂ",
