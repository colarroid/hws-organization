...
const en: Record<MessageKey, string> = {
  ...
  "stats.reachedNote": "went through to you",
  "stats.profileViews": "profile visits",
  "stats.profileViewsNote": "read about you",
...
const gd: Catalogue = {
  ...
  "stats.reachedNote": "chaidh iad troimhe thugaibh",
  "stats.profileViews": "tadhalan pròifil",
  "stats.profileViewsNote": "leugh iad mur deidhinn",
...
const sco: Catalogue = {
  ...
  "stats.reachedNote": "gaed throu tae ye",
  "stats.profileViews": "profile veesits",
  "stats.profileViewsNote": "read aboot ye",
...
const pl: Catalogue = {
  ...
  "stats.reachedNote": "przeszły do was",
  "stats.profileViews": "odsłon profilu",
  "stats.profileViewsNote": "przeczytały o was",
...
const uk: Catalogue = {
  ...
  "stats.reachedNote": "перейшли до вас",
  "stats.profileViews": "переглядів профілю",
  "stats.profileViewsNote": "прочитали про вас",
  ...
  "empty.body":
    "Пропозиція — це одна річ, на яку жінка може відгукнутися: курс, грант, відкритий прийом, місце в менторстві. Ваші показники почнуться тут, щойно перша стане активною.",
...
const ar: Catalogue = {
  ...
  "stats.reachedNote": "انتقلن إليكم",
  "stats.profileViews": "زيارة للملف",
  "stats.profileViewsNote": "قرأن عنكم",
...
const ur: Catalogue = {
  ...
  "stats.reachedNote": "آپ تک پہنچیں",
  "stats.profileViews": "پروفائل وزٹ",
  "stats.profileViewsNote": "آپ کے بارے میں پڑھا",
  "period.week": "اس ہفتے",
...
const pa: Catalogue = {
  ...
  "stats.reachedNote": "ਤੁਹਾਡੇ ਤੱਕ ਪਹੁੰਚੀਆਂ",
  "stats.profileViews": "ਪ੍ਰੋਫਾਈਲ ਵੇਖੇ ਗਏ",
  "stats.profileViewsNote": "ਤੁਹਾਡੇ ਬਾਰੇ ਪੜ੍ਹਿਆ",
...
const zh: Catalogue = {
  ...
  "stats.reached": "位女性触达",
  "stats.reachedNote": "点击前往你们",
  "stats.profileViews": "次主页访问",
  "stats.profileViewsNote": "阅读了关于你们的介绍",
  "period.week": "本周",
  "period.month": "本月",
  "period.all": "全部时间",
